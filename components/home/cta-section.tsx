...
export function CtaSection() {
  ...
  return (
    ...
    >
      ...
      <div className="cta-pulse absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-screen h-[100vw] bg-primary-400 rounded-full opacity-5 pointer-events-none" />
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          <div className="cta-book w-full max-w-70 lg:max-w-[320px] aspect-2/3 shrink-0 perspective-[2000px]">
            <BookCard
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-8">
            ...
            <h2 className="cta-anim text-4xl md:text-5xl lg:text-7xl font-heading font-black text-white leading-[1.05] tracking-tight">
              ...
              <span className="text-secondary-950 italic font-medium">
                everything?
              </span>
            </h2>
            ...
            <p className="cta-anim text-lg md:text-xl text-white/80 leading-relaxed font-light max-w-xl">
              Get your copy of Synthetic Heart today—and discover why readers
              and critics are calling it the most thought-provoking thriller of
              the decade.
            </p>
